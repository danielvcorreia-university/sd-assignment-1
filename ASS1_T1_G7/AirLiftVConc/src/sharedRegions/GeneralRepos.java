    ...
    private void reportStatus ()
    {
        ...
        { case PilotStates.AT_TRANSFER_GATE:   lineStatus += " ATRG ";
            ...
            case PilotStates.READY_FOR_BOARDING: lineStatus += " RDFB ";
                break;
            case PilotStates.WAITING_FOR_BOARDING: lineStatus += " WTFB ";
                break;
        ...
        switch (hostessState)
        { case HostessStates.WAIT_FOR_FLIGHT:   lineStatus += " WTFL ";
            break;
            case HostessStates.WAIT_FOR_PASSENGER: lineStatus += " CKPS ";
                break;
            case HostessStates.CHECK_PASSENGER: lineStatus += " WTPS ";
                break;
